...
Trust scores and related fields appear in **list and detail** responses from the API and in the **web** marketplace agent browser. All use the same numbers from the registry.
