            ...
            "output_schema": _output_schema_object(
                {
                    ...
                    "tool": {
                        "type": "string",
                        "description": "'ruff' for Python, 'llm' for JS/TS",
                    },
                    "issues": {
                        "type": "array",
                        "items": {
            ...
            "input_schema": {
                ...
                "properties": {
                    ...
                    "working_dir": {
                        "type": "string",
                        "default": "/tmp",
                        "description": "Working directory (must exist on server)",
                    },
                    "env": {
                        "type": "object",
        ...
        },
        {
            ...
            "input_schema": {
                ...
                "properties": {
                    "code": {
                        "type": "string",
                        "description": "Source code to type-check",
                    },
                    "language": {
                        "type": "string",
                    ...
                    "strict": {
                        "type": "boolean",
                        "default": False,
                        "description": "Enable strict mode (--strict for mypy / strict tsconfig)",
                    },
                },
                "required": ["code"],
            },
