...
_DEFAULT_CATEGORY_BY_AGENT_ID = {
    ...
    JWT_DEBUGGER_AGENT_ID: "Security",
...
_DEFAULT_RUNTIME_REQUIREMENTS_BY_AGENT_ID = {
    ...
    JWT_DEBUGGER_AGENT_ID: ["cryptography"],
...
_DEFAULT_TOOLING_KIND_BY_AGENT_ID = {
    ...
    JWT_DEBUGGER_AGENT_ID: "tool_execution",
...
_DEFAULT_SHORT_USE_CASES_BY_AGENT_ID = {
    ...
    JWT_DEBUGGER_AGENT_ID: ["debug a JWT", "detect alg confusion attack", "verify token signature"],
