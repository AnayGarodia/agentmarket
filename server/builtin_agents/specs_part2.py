            ...
            "input_schema": _output_schema_object(
                {
                    "prompt": {
                        ...
                        "maxLength": 1200,
                        "examples": [
                            "A retro-futurist skyline at sunrise, cinematic lighting"
                        ],
                    },
                    "style": {
                        "type": "string",
            ...
            "output_schema": _output_schema_object(
                {
                    ...
                    "billing_units_actual": {
                        "type": "integer",
                        "description": "Actual number of images produced; used for variable-pricing refunds.",
                    },
                },
            ...
            "input_schema": _output_schema_object(
                {
                    "brief": {
                        ...
                        "maxLength": 4000,
                        "examples": [
                            "Launch teaser for an AI healthcare assistant for busy parents."
                        ],
                    },
                    "duration_seconds": {
                        "type": "integer",
            ...
            "output_schema": _output_schema_object(
                {
                    ...
                    "billing_units_actual": {
                        "type": "integer",
                        "description": "Actual seconds of video rendered; used for variable-pricing refunds.",
                    },
                },
        ...
        },
        {
            ...
            "input_schema": {
                ...
                "properties": {
                    "query": {
                        "type": "string",
                        "description": "Search query (keywords, author name, topic)",
                        "example": "diffusion models image generation",
                    },
                    "max_results": {
                        "type": "integer",
                        "default": 8,
                    ...
                    "categories": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": "arXiv category filters e.g. cs.AI, stat.ML",
                        "example": ["cs.LG", "cs.AI"],
                    },
                    "full_abstract": {
                        "type": "boolean",
                        "default": False,
                        "description": "Fetch full abstract page for top 3 papers to extract affiliations and related links",
                    },
                },
                "required": ["query"],
            },
            "output_schema": _output_schema_object(
                {
                    ...
                    "billing_units_actual": {
                        "type": "integer",
                        "description": "Actual number of papers returned; used for variable-pricing refunds.",
                    },
                },
            ...
            "output_examples": [
                {
                    ...
                    "output": {
                        ...
                        "open_questions": [
                            "Can attention fully replace inductive biases from CNNs?",
                            "Scaling limits of self-supervised vision models",
                        ],
                        "suggested_follow_ups": [
        ...
        },
        {
            ...
            "input_schema": {
                ...
                "properties": {
                    "url": {
                        "type": "string",
                        "description": "Public URL to fetch and analyze",
                        "example": "https://en.wikipedia.org/wiki/Large_language_model",
                    },
                    "urls": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": "Multiple URLs to fetch and cross-reference (max 10)",
                    },
                    "question": {
                        "type": "string",
                        "default": "",
                        "description": "Specific question to answer from the page content",
                    },
                    "mode": {
                        "type": "string",
                        "enum": ["summary", "extract", "qa"],
                        "default": "summary",
            ...
            "output_schema": _output_schema_object(
                {
                    ...
                    "per_url_findings": {
                        "type": "array",
                        "items": {"type": "object"},
                        "description": "Per-URL fetch status and content_length (no raw content)",
                    },
                    "synthesis": {
                        "type": "string",
                        "description": "LLM synthesis across all fetched content",
                    },
                    "cross_source_consensus": {
                        "type": ["string", "null"],
                        "description": "Single sentence on what all sources agree on (null for single-URL calls)",
                    },
                    "billing_units_actual": {
                        "type": "integer",
                        "description": "Number of URLs successfully fetched; used for variable-pricing refunds.",
                    },
                },
            ...
            "output_examples": [
                {
                    ...
                    "output": {
                        ...
                        "quotes": [
                            ...
                            "The model architecture avoids recurrence",
                        ],
                        "links": [
                            {
