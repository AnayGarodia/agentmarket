...
def render_splash() -> None:
    if _HAS_RICH:
        ...
        body.append("aztea publish <path>", style="code")
        body.append("  list a new agent (SKILL.md, agent.md, .py)\n", style="muted")
    ...
    console.print("aztea publish <path>  list a new agent (SKILL.md, agent.md, .py)")
