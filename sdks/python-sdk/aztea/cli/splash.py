...
def render_splash() -> None:
    if _HAS_RICH:
        ...
        body.append("aztea publish       ", style="code")
        body.append("interactive wizard — list a new agent in 30 seconds\n", style="muted")
    ...
    console.print("aztea publish      interactive wizard — list a new agent")
